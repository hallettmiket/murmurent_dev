...
[`CLAUDE.md`](https://github.com/hallettmiket/murmurent/blob/main/CLAUDE.md) is the architectural overview Claude Code itself loads.
...
| [**`murmurent_dev`**](https://github.com/hallettmiket/murmurent_dev) | **Development.** All history, issues, pull requests and design discussion. Its README is written for people working on Murmurent, not using it. |
...
- **Using murmurent?** You are in the right place. Install from either the PyPI
  or the one-command route above; both give you the latest release.
